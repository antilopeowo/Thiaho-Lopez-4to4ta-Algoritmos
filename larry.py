...
def Ejercicio1_2_6():
  ...
  "Nombre":"Thiago",
            ...
            "Edad":16,
            "Ciudad":"CABA",
            "Profesion":"Abastecedor logistico en lugares de alta concentracion"
        }
    print(f"""
            ...
            Profesion: {informacion['Profecion']}
            """)
    #Ejercicio 2

    informacion["Telefono"]=1140978500
    informacion["Email"]="thiagolopezagustin@gmail.com"
    print(f"""
            Nombre: {informacion["Nombre"]}
            Apellido: {informacion['Apellido']}
            Edad: {informacion['Edad']}
